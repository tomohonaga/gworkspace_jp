  ...
  if (self)
    {
      ...
      [errLabel setFont: [NSFont systemFontOfSize: 16]];
      ...
      [explLabel1 setFont: [NSFont labelFontOfSize: 11]];
      [explLabel2 setFont: [NSFont labelFontOfSize: 10]];
      [explLabel3 setFont: [NSFont labelFontOfSize: 10]];
      
      [explLabel1 setStringValue: NSLocalizedString(@"Double-click to open selected document", @"")];
      [explLabel2 setStringValue: NSLocalizedString(@"Click 'Set Default' to set default application", @"")];
      [explLabel3 setStringValue: NSLocalizedString(@"for all documents with this extension", @"")];
     ////
    }
...
- (void)activateForPaths:(NSArray *)paths
{
  ...
  if ([paths count] == 1)
    { 
      ...
      ////
      [titleField setFont: [NSFont systemFontOfSize: 19]];
      ////
