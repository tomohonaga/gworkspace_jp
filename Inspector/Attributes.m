  ...
  if (self)
    {
      ...
      [okButt setEnabled: NO];
  	  ...
  	  //NSLog(@"font %@", font);
  	  [linkToLabel setFont: [NSFont labelFontOfSize: 11]];
  	  //[sizeLabel setFont: [NSFont labelFontOfSize: 12]];
  	  [groupLabel setFont: [NSFont labelFontOfSize: 11]];
  	  //[ownerLabel setFont: [NSFont labelFontOfSize: 12]];
  	  ////
  ...
  if ([insppaths count] == 1)
    { /* Single Selection */
      ...
      ////
       ...
       //[titleField setFont: [NSFont boldFontOfSize: 18]];
      ////
